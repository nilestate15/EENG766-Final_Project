...
def gen_baseline_data():
    ...
    # Real AC data
    GPS_PR, GPS_PR_0, GPS_pos_0, GPS_pos_matrix, AC_dt, AC_x0, truth_table_baseline = gen_flight_data(ENU_cfp, ENU_cfp_ECEF, Cdt, Cdt_dot)
    ...
    est_state_mat_baseline = np.zeros((num_coords, len(AC_x0)))
    ...
    cov_bounds_baseline = np.zeros((num_coords, len(AC_x0)))
    ...
    for i in range(num_coords):
        ...
        if nan_meas.all() == True:
            ...
            est_state_mat_baseline[i] = curr_x
            est_cov_mat[i] = curr_P
            cov_bounds_baseline[i] = std_cov
    ...
    return truth_table_baseline, est_state_mat_baseline, cov_bounds_baseline
